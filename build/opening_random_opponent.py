#!/usr/bin/env python3
"""
Opening Only + Random Move Opponent
Plays opening book moves when available, random moves otherwise
"""
...
def main():
    print("Opening Only + Random Move Opponent")
    print("=" * 40)
    
    engine = create_opponent(OpponentType.OPENING_ONLY_RANDOM.value)
    board = chess.Board()
